...
export default function CyberSecurity() {
  ...
  useEffect(() => {
    const fetchVideos = async () => {
      const url = `https://youtube138.p.rapidapi.com/search/?q=Cybersecurity&hl=en&gl=US&maxResults=30`;
      const options = {
        method: 'GET',
        headers: {
          'x-rapidapi-key': 'd984697c89mshbe33dbe91ed22f1p149c7djsn93222271b3f9', // API key added directly
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Cybersecurity Course</h1>
