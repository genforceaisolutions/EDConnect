...
export default function DataScience() {
  ...
  useEffect(() => {
    const fetchVideos = async () => {
      const url = `https://youtube138.p.rapidapi.com/search/?q=Data%20Science&hl=en&gl=US&maxResults=30`;
      const options = {
        method: 'GET',
        headers: {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Data Science Course</h1>
