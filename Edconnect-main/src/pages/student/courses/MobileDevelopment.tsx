...
export default function MobileDevelopment() {
  ...
  useEffect(() => {
    const fetchVideos = async () => {
      const url = `https://youtube138.p.rapidapi.com/search/?q=Mobile%20Development&hl=en&gl=US&maxResults=30`;
      const options = {
        method: 'GET',
        headers: {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Mobile Development Course</h1>
